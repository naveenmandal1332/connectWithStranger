...
const ChatContainer = (props) => {
  ...
  // console.info("PropsId: ", props.userId);
  // console.info("SOCKET ", props.socketInfo);
  console.info("User info: ", props.userInfo);

  useEffect(() => {
    const socket = props.socketInfo;
  ...
  const handleSendMessage = () => {
    ...
    console.info("Sender Id: ", message.sender);
